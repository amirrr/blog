...
> = {
  ...
  "ai-climate-model": dynamic(
    () =>
      import("@/app/research/details/AiClimateModelDetails").then(
        (mod) => mod.default
      ),
    {
      // Path updated
  ...
  "quantum-entanglement-simulator": dynamic(
    () =>
      import("@/app/research/details/QuantumEntanglementSimulatorDetails").then(
        (mod) => mod.default
      ),
    {
      // Path updated
  ...
  "nlp-healthcare-analysis": dynamic(
    () =>
      import("@/app/research/details/NlpHealthcareAnalysisDetails").then(
        (mod) => mod.default
      ),
    {
      // Path updated
  ...
  "ethical-ai-framework": dynamic(
    () =>
      import("@/app/research/details/EthicalAiFrameworkDetails").then(
        (mod) => mod.default
      ),
    {
      // Path updated
